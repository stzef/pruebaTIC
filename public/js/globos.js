...
var contenedorGlobos = document.getElementById("contenedorGlobos")

//capturar ancho y largo del lienzo svg
var widthContenedorGlobos = contenedorGlobos.width.animVal.value
var heightContenedorGlobos = contenedorGlobos.height.animVal.value
...
//funcion listener para reintentar
function reintentar(){
	...
	//se actualiza el numero de veces pinchado fuera de los globos
